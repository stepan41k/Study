...
# Вкладка 3: РАВНОМЕРНОЕ
tab3 = ttk.Frame(notebook)
notebook.add(tab3, text=" Равномерное ")
f3 = tk.LabelFrame(tab3, text=" Параметры (a, b) ", padx=10, pady=10)
f3.pack(padx=20, pady=10, fill="x")
tk.Label(f3, text="a").grid(row=0, column=0)
ent_uni_a = tk.Entry(f3, width=10)
ent_uni_a.insert(0, "0")
ent_uni_a.grid(row=0, column=1)
tk.Label(f3, text="b").grid(row=0, column=2)
ent_uni_b = tk.Entry(f3, width=10)
ent_uni_b.insert(0, "1")
ent_uni_b.grid(row=0, column=3)
tk.Label(f3, text="N").grid(row=0, column=4)
ent_uni_n = tk.Entry(f3, width=10)
ent_uni_n.insert(0, "20")
ent_uni_n.grid(row=0, column=5)
tk.Label(f3, text="Δ1").grid(row=1, column=0)
ent_uni_d1 = tk.Entry(f3, width=15, state="readonly")
ent_uni_d1.grid(row=1, column=1, columnspan=2)
tk.Label(f3, text="Δ2").grid(row=1, column=3)
ent_uni_d2 = tk.Entry(f3, width=15, state="readonly")
...
txt_uni_table = tk.Text(tab3, height=10, width=55, font=("Courier New", 11))
txt_uni_table.pack()
